...
namespace Quokka.RTL
{
    public class RTLBitArrayConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "U":
                    return new RTLBitArray(RTLBitArrayInitType.MSB, RTLDataType.Unsigned, parts[1], parts[1].Length);
                case "S":
                    return new RTLBitArray(RTLBitArrayInitType.MSB, RTLDataType.Signed, parts[1], parts[1].Length);
                default:
                    return null;
            }
        }
