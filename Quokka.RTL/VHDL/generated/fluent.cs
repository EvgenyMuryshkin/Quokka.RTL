...
public partial class vhdArchitectureDeclarations
{
	...
	public vhdArchitectureDeclarations WithSubTypeDeclaration(String Name, vhdDataType DataType, Int32 Width)
	{
		this.Children.Add(new vhdSubTypeDeclaration(Name, DataType, Width));
		return this;
	}
	//vhdFunction
	...
	public vhdArchitectureDeclarations WithFunction(String Name, vhdDataType DataType, Int32 Width)
	{
		this.Children.Add(new vhdFunction(Name, DataType, Width));
		return this;
	}
}
...
public partial class vhdEntityInterface
{
	...
	public vhdEntityInterface WithStandardEntityPort(String Name, vhdPortDirection Direction, vhdDataType DataType, Int32 Width, String Initializer)
	{
		this.Children.Add(new vhdStandardEntityPort(Name, Direction, DataType, Width, Initializer));
		return this;
	}
}
...
public partial class vhdFunctionInterface
{
	...
	public vhdFunctionInterface WithFunctionPortDeclaration(String Name, vhdDataType DataType, Int32 Width)
	{
		this.Children.Add(new vhdFunctionPortDeclaration(Name, DataType, Width));
		return this;
	}
...
public partial class vhdFunctionTypeDeclarations
{
	...
	public vhdFunctionTypeDeclarations WithSubTypeDeclaration(String Name, vhdDataType DataType, Int32 Width)
	{
		this.Children.Add(new vhdSubTypeDeclaration(Name, DataType, Width));
		return this;
	}
